...
paru -S --noconfirm brave-bin google-chrome thunar visual-studio-code-bin spotify spicetify-cli powercord-electron-git keepassxc ntfs-3g pydf ookla-speedtest-bin
